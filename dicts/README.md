...
- 删除了「棤」字的错误音码 `qh`
- 删除繁体的「軎」，添加其简体「𰹲」
- 「啥」字笔画错误，由 `oivv` 改为 `oivu`
- 「彘」字笔顺错误，由 `aauv` 改为 `aava`，受此影响微调了顺序
- 「缶」字取码错误，由 `uvvi` 改为 `uvuo`，受此影响微调了顺序
- 「忝」、「恭」、「慕」笔画错误，「⺗」笔顺应为「竖、点、点、点」
- 「平」字取码错误，虽为独体字，取码时也应取字根「十」
- 「弢」字笔顺错误，由 `avia` 改为 `avai`
...
- 「啰唆」为推荐词形，放到「啰嗦」之前（「太啰唆」、「啰里啰唆」、「啰啰唆唆」类似）
- 「泥子」为推荐词形，放到「腻子」前
...
- `tjw` 编码下，「停车位」放在「天极网」之前，使「停车位」排序与其飞键 `tww` 一致
- 添加「挓挲」，此为「扎煞」的推荐词形
- 「波罗蜜」为推荐词形，放在「菠萝蜜」之前
- 「木波罗」为《现汉》收录词条，放于「木菠萝」之前
- 「找碴」（𖿲）为推荐词形，添加在「找茬」之前
- 「闺密」为推荐词形，添加在「闺蜜」之前
- 「姨父」为推荐词形，添加在「姨夫」之前
- 「红运」为推荐词形，将「鸿运」置后
...
- 「西蓝花」为推荐词形，将「西兰花」置后
- 「消夜」为推荐词形，将「宵夜」置后
- 「波希米亚」为辞海收录翻译，将「波西米亚」置后
- 「恺撒」为辞海收录翻译，将「凯撒」置后
- 「镔铁」为现汉收录（推荐）词形，将「宾铁」置后
- 「嗍粉」为正确词形，本为字词错误，但保留「嗦粉」置后
